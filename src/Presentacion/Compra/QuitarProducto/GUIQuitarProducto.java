 ...
 * 
 */
package Presentacion.Compra.QuitarProducto;
...
public class GUIQuitarProducto extends JFrame implements Observer {
	...
	public GUIQuitarProducto()
	{
		super("QUITAR PRODUCTO");
		initGUI();
	}
	...
	private void initGUI() {
		...
		accept.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				o[0] = carrito;
				o[1] = seleccion.getSelectedItem();
				Context contexto = new Context(Events.RES_QUITAR_PRODUCTO_OK_VIEW, o);
		...
		cancel.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				Context contexto = new Context(Events.RES_QUITAR_PRODUCTO_KO_VIEW, carrito);
				Controller.getInstance().handle(contexto);
				dispose();
			}
		});

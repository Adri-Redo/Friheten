package Presentacion.Personal.MostrarPersonalPorNif;
...
public class GUIMostrarPersonalPorNif extends JFrame implements Observer {
	...
	public GUIMostrarPersonalPorNif() {
		super("CONSULTAR PERSONAL POR NIF");
		this.initGUI();
	}
	...
	private void initGUI() {
		...
		JLabel consultarHabilidad = new JLabel("Introduzca el NIF de la persona: ");
		...
		ok.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				String nif = cuadroTexto.getText().trim();
				...
				if (validar) {
					...
					Controller.getInstance().handle(new Context(Events.MOSTRAR_PERSONAL_PORNIF_OK_VIEW, nif));
				}
		...
		ko.addActionListener((e) -> {
			...
			Controller.getInstance().handle(new Context(Events.MOSTRAR_PERSONAL_PORNIF_KO_VIEW, null));
			dispose();
		});
